...
const CheckoutForm = ({ onSubmit }: IProps) => {
  ...
  return (
    ...
    >
      <S.Title>{t('checkout_summary.shipping_address')}</S.Title>

      <Input
        label={t('checkout_form.email')}
        type="email"
        id="email"
        name="email"
        value={email}
      ...
      />
      <Input
        label={t('checkout_form.street')}
        type="text"
        name="streetAddress"
        id="street_address"
        value={streetAddress}
        placeholder={t('checkout_form.street_placeholder')}
        onChange={handleChange}
        required
      />
      <Input
        ...
        id="zip_code"
        value={zipCode}
        placeholder={t('checkout_form.zip_code_placeholder')}
        onChange={handleChange}
        required
      />
      <Input label={t('checkout_form.city')} type="text" name="city" id="city" value={city} placeholder={t('checkout_form.city_placeholder')} required onChange={handleChange} />

      <S.StateRow>
        <Input label={t('checkout_form.state')} type="text" name="state" id="state" value={state} placeholder={t('checkout_form.state_placeholder')} required onChange={handleChange} />
        <Input
      ...
      <Input
        type="text"
        label={t('checkout_form.card_number')}
      ...
      <S.SubmitContainer>
        ...
        <S.CartButton data-cy={CypressFields.CheckoutPlaceOrder} type="submit">{t('cart.place_order')}</S.CartButton>
      </S.SubmitContainer>
    </S.CheckoutForm>
  );
};
